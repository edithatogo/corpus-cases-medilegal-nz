...
class MojTribunalsSourceAdapter(SourceAdapter):
    ...
    def fetch(self) -> list[dict[str, Any]]:
        """Fetch and parse MoJ Tribunals listing records."""
    ...
    def process(self, raw_cases: list[dict[str, Any]]) -> list[dict[str, Any]]:
        """Ensure MoJ Tribunals records carry source and metadata containers."""
    ...
    def validate(self, cases: list[dict[str, Any]]) -> bool:
        """Return whether all MoJ Tribunals records contain the required fields."""
        for case in cases:
