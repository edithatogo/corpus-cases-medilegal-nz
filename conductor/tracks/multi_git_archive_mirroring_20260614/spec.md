...
## Overview
This track implements multi-git repository mirroring and backup publishing strategies for the `corpus-cases-medilegal-nz` pipeline to guarantee durability and prevent censorship or single-point-of-failure repository/dataset takedowns.
...
2. **Multi-Archive Datasets**: Set up redundant archiving. In addition to Hugging Face, establish plans for publishing annual or periodic snapshots to Zenodo (requesting a DOI) and optional review/mirror packages to OSF.
